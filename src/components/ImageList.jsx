...
// SUB-COMPONENT
const Image = ({ url, publicId, number, setUploadedPhotos, setPhotos }) => {
  const dispatch = useDispatch()

  const removePhotoFileAndState = (url, number) => {
    // REMOVE PHOTO IN <FILE> FORMAT
    setUploadedPhotos((prev) => {
      // NUMBER - 1 = INDEX
      let tempList = [...prev]
      tempList.splice(number - 1, 1)
      return tempList
    })
...
// MAIN-COMPONENT
const ImageList = ({ setUploadedPhotos, setPhotos }) => {
